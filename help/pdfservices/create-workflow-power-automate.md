...
[Adobe PDFサービス](https://flow.microsoft.com)コネクタを使用して、[Microsoft Power Automate](https://us.flow.microsoft.com/en-us/connectors/shared_adobepdftools/adobe-pdf-services/)で最初のフローを作成する方法について説明します。
...
1. **[!UICONTROL テンプレートファイルコンテンツ]**&#x200B;フィールドで、**[!UICONTROL ダイナミックコンテンツ]**&#x200B;パネルを使用して、**[!UICONTROL ファイルコンテンツを取得]**&#x200B;手順の&#x200B;*ファイルコンテンツ*&#x200B;値を挿入します。
...
1. **[!UICONTROL ファイルコンテンツ–1]**&#x200B;フィールドで、**[!UICONTROL ダイナミックコンテンツ]**&#x200B;パネルを使用して、*WordをPDFに変換*&#x200B;手順の&#x200B;**[!UICONTROL PDFファイルコンテンツ]**&#x200B;の値を入力します。
1. 次のドキュメントを追加するには、**+ [!UICONTROL 新しいアイテムの追加]**&#x200B;を選択します。
1. **[!UICONTROL ファイルコンテンツ – 2]**&#x200B;フィールドで、**[!UICONTROL ダイナミックコンテンツ]**&#x200B;パネルを使用して、**[!UICONTROL Wordテンプレートから文書を生成]**&#x200B;手順の&#x200B;*出力ファイルコンテンツ*&#x200B;の値を挿入します。
...
1. **[!UICONTROL ファイルコンテンツ]**&#x200B;フィールドで、**[!UICONTROL ダイナミックコンテンツ]**&#x200B;パネルを使用して、*結合PDF*&#x200B;の手順の&#x200B;**[!UICONTROL PDFファイルコンテンツ]**&#x200B;の値を入力します。
...
1. Power Automateでフローを編集する際に、**PDFを結合**&#x200B;操作と&#x200B;**[!UICONTROL ファイルを作成]**&#x200B;操作の間にある&#x200B;**[!UICONTROL +]**&#x200B;を選択します。
